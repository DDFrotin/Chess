...
public class Board {
    ...
    public boolean isSquareEmpty(Coordinates coordinates) { // Проверка на пустоту клетки
        return !pieces.containsKey(coordinates);
    }

    public Piece getPiece(Coordinates coordinates) { //Получение фигуры по координатам
        return pieces.get(coordinates);
    }
    public void setupDefaultPiecePositions() { // Расстановка фигур по дефолту
